...
export default function TopBar({ title }) {
  const { user, logout, t, photo, setSideOpen } = useApp()
  ...
  return (
    <>
      <div className="ps-top">
        {/* Гамбургер — только на мобильном, открывает выдвижной сайдбар */}
        <button className="ps-burger" onClick={() => setSideOpen(true)} title={t('Меню')}>
        ...
        >
          ...
          <span className="lbl" style={{ flex: 1, textAlign: 'left' }}>{t('Поиск по порталу…')}</span>
          <kbd style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <div className="ps-m-hide" style={{ textAlign: 'right', lineHeight: 1.15 }}>
